...
The test commits precede any production-code change. The next gate is CI evidence that the new regression fails on the old implementation, followed by the minimal implementation described in the design document.