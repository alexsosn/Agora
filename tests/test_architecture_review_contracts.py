...
class ResourceIntegrationMetadataTests(unittest.TestCase):
    ...
    def test_service_exposes_integration_and_source_configuration(self):
        ...
        self.assertEqual(item["licenses"]["data"], "CC-BY-4.0")
        self.assertEqual(item["licenses"]["redistribution"], "permitted")
        self.assertEqual(item["licenses"]["evidence"]["status"], "resolved")
